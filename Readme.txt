...
3、算法更新:
    (1) data_update_sql.py -> 根据特定需要利用改进的算法更新数据库中的数据字段, 主要更新crisis、wjwords(危机事件识别)以及nextevent(事件预测)
4、拷贝文件:
    将dict文件夹中的 'themename'_countryviews_dict.pkl拷入EventTopicBackend项目dict中, 用于主页面的地图的数据显示